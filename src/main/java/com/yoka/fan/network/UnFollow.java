...
public class UnFollow extends Request{
	...
	public UnFollow(String user_id, List<String> target_ids, String access_token) {
	...
	public UnFollow(String user_id, String target_id, String access_token) {
		super();
		this.user_id = user_id;
